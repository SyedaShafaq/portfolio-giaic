  ...
  export const servicesData = [
    {
      ...
      description:"Tailored web apps built with the latest technologies & super.",
      icon: "/images/s1.png",
    },
    {
      id: 2,
      title:"E-commerce Websites",
      description:"Secure online stores with user-friendly shopping and payment ",
      icon: "/images/s2.png",
    },
    {
      id: 3,
      title:"API Integration ",
      description:"Seamless integration for smooth data sharing and functionality and",
      icon: "/images/s3.png",
    },
    {
      id: 4,
